...
\caption{Triangle ABC with medians AD, BE and CF}
\label{fig:1.2}	
\end{figure} 
\newpage
\item \section{ALTITUDES}
\begin{table}[!ht]
...
\caption{Triangle ABC with altitudes $AD_1$, $BE_1$ and $CF_1$}
\label{fig:1.3}	
\end{figure}  
\newpage
...
\caption{circumcircle of triangle ABC with circumcentre O}
\label{fig:1.4}	
\end{figure} 
\newpage
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{./figs/1.5.png}
\caption{incircle of triangle ABC with incentre I}
\label{fig:1.5}	
\end{figure}  
\end{enumerate}                                           
\end{document}
