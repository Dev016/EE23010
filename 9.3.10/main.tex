...
\begin{align}
	p_X\brak{k} &= \comb{n}{k}\brak{p}^k\brak{1-p}^{n-k}\\
	&= \comb{4}{k}\brak{0.9}^k\brak{0.1}^{4-k}
\end{align}
Now, the probability that none of the balls drawn is marked with zero
\begin{align}
	p_X\brak{4} &= \comb{4}{4}\brak{0.9}^4\brak{0.1}^0\\
	&= 0.6561
\end{align}
Let Y be a gaussian variable,
\begin{align}
	Y &= \frac{X - \mu}{\sigma}
\end{align}
The pdf is given by
